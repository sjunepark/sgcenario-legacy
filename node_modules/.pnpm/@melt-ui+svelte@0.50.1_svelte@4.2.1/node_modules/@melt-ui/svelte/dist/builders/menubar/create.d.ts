...
export declare function createMenubar(props?: CreateMenubarProps): {
    elements: {
        menubar: import("../../internal/helpers/index.js").ExplicitBuilderReturn<import("svelte/store").Stores | undefined, (node: HTMLElement) => {
            destroy?: undefined;
        } | {
            destroy: typeof noop;
        }, () => {
    ...
    builders: {
        createMenu: (props?: CreateMenubarMenuProps) => {
            elements: {
                menu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<boolean>, import("svelte/store").Writable<string | HTMLElement | null | undefined>], (node: HTMLElement) => MeltActionReturn<MenubarEvents['menu']>, ([$isVisible, $portal]: [boolean, string | HTMLElement | null | undefined]) => {
                    readonly role: "menu";
                ...
                trigger: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<boolean>], (node: HTMLElement) => MeltActionReturn<MenubarEvents['trigger']>, ([$rootOpen]: [boolean]) => {
            ...
            builders: {
                ...
                createSubmenu: (args?: import("../menu/types.js")._CreateSubmenuProps | undefined) => {
                    elements: {
                        subTrigger: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>], (node: HTMLElement) => MeltActionReturn<"click" | "focusin" | "focusout" | "keydown" | "pointerleave" | "pointermove">, ([$subOpen, $disabled]: [boolean, boolean]) => {
                            readonly role: "menuitem";
                            readonly id: string;
                            readonly tabindex: -1;
                            readonly 'aria-controls': string;
                        ...
                        subMenu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<boolean>], (node: HTMLElement) => MeltActionReturn<"focusout" | "keydown" | "pointermove">, ([$subIsVisible]: [boolean]) => {
                            readonly role: "menu";
                            readonly hidden: true | undefined;
                            readonly style: string;
                            readonly id: string;
