...
export declare function createContextMenu(props?: CreateContextMenuProps): {
    elements: {
        menu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[Readable<boolean>, import("svelte/store").Writable<string | HTMLElement | null | undefined>], (node: HTMLElement) => MeltActionReturn<ContextMenuEvents['menu']>, ([$isVisible, $portal]: [boolean, string | HTMLElement | null | undefined]) => {
            readonly role: "menu";
    ...
    builders: {
        createSubmenu: (args?: import("../menu/types.js")._CreateSubmenuProps | undefined) => {
            elements: {
                ...
                subMenu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[Readable<boolean>], (node: HTMLElement) => MeltActionReturn<"focusout" | "keydown" | "pointermove">, ([$subIsVisible]: [boolean]) => {
                    readonly role: "menu";
                    readonly hidden: true | undefined;
                    readonly style: string;
                    readonly id: string;
