...
export declare function createTooltip(props?: CreateTooltipProps): {
    elements: {
        trigger: import("../../internal/helpers/index.js").ExplicitBuilderReturn<import("svelte/store").Stores | undefined, (node: HTMLElement) => MeltActionReturn<TooltipEvents['trigger']>, () => {
