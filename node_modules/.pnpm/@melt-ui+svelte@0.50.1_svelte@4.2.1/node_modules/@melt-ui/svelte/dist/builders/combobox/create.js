...
export function createCombobox(props) {
    ...
    const inputValue = writable(Array.isArray(withDefaults.defaultSelected) ? '' : withDefaults.defaultSelected?.label ?? '');
