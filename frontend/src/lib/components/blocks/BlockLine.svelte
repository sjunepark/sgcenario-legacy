<script lang="ts">
	...
	import { setScrollbar } from "$lib/utils";
	...
	const scrollbarStyle = getContext("scrollbarStyle") as Partial<Options>;
...
{#if $open}
	...
	>
		<div
			use:setScrollbar={scrollbarStyle}
			class="flex max-h-full flex-col items-stretch overflow-y-auto"
		>
